...
public class UserDBManager implements IUserDataManager {
        ...
        List<DataDO> rList = DataFilterUtil.filter(list, new DataFilterUtil.FilterFunction<DataDO>() {
            ...
            public boolean isSelected(DataDO d) {
                if (q == null) {
                	...
                	//here list some other paramerts to filter the database !!!
//                    if (q.getType() != null) {
...
//                    }
    ...
    private List<DataDO> readData() { // read all the CVS data into the List DataDO
